...
in JavaScript, although some conventions (i.e async/await or static class
fields) may still be included or prohibited on a case-by-case basis. Currently,
anything prior to stage 3 is not included nor recommended in this guide.
...
- Only include one React component per file.
  - However, multiple [Stateless, or Pure, Components][stateless-functions] are
    allowed per file. eslint:
...
- [`react/forbid-prop-types`][react-forbid-prop-types] will allow `arrays` and
  `objects` only if it is explicitly noted what `array` and `object` contains,
  using `arrayOf`, `objectOf`, or `shape`.

[stateless-functions]: https://facebook.github.io/react/docs/reusable-components.html#stateless-functions
[react-no-multi-comp]: https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/no-multi-comp.md#ignorestateless
[react-forbid-prop-types]: https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/forbid-prop-types.md
...
- If you have internal state and/or refs, prefer `class extends React.Component`
  ...
  [`react/prefer-stateless-function`][react-prefer-stateless-function]
...
[react-prefer-es6-class]: https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/prefer-es6-class.md
...
- [Do not use mixins][mixins-harmful].
...
[mixins-harmful]: https://facebook.github.io/react/blog/2016/07/13/mixins-considered-harmful.html
...
- **Reference Naming**: Use PascalCase for React components and camelCase for
  their instances. eslint: [`react/jsx-pascal-case`][react-jsx-pascal-case]
...
[react-jsx-pascal-case]: https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/jsx-pascal-case.md

## Declaration

- Do not use `displayName` for naming components. Instead, name the component
  by reference.
...
- Follow these alignment styles for JSX syntax. eslint:
  ...
  [`react/jsx-closing-tag-location`][react-jsx-closing-tag-location]
...
- Always use double quotes (`"`) for JSX attributes, but single quotes (`'`)
  for all other JS. eslint: [`jsx-quotes`][jsx-quotes]
...
[react-jsx-tag-spacing]: https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/jsx-tag-spacing.md
[react-jsx-curly-spacing]: https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/jsx-curly-spacing.md
...
- Omit the value of the prop when it is explicitly `true`. eslint:
  [`react/jsx-boolean-value`][react-jsx-boolean-value]
...
- Always include an `alt` prop on `<img>` tags. If the image is presentational,
  ...
  eslint: [`jsx-a11y/alt-text`][jsx-a11y-alt-text]
...
- Do not use words like "image", "photo", or "picture" in `<img>` `alt` props.
  eslint: [`jsx-a11y/img-redundant-alt`][jsx-a11y-img-redundant-alt]

  > Why? Screenreaders already announce `img` elements as images, so there is
  > no need to include this information in the alt text.
...
- Use only valid, non-abstract [ARIA roles][aria-roles]. eslint:
...
- Do not use `accessKey` on elements. eslint:
  ...
  > Why? Inconsistencies between keyboard shortcuts and keyboard commands used
  > by people using screenreaders and keyboards complicate accessibility.
...
- Avoid using an array index as `key` prop, prefer a stable ID. eslint:
  [`react/no-array-index-key`][react-no-array-index-key]

  > Why? Not using a stable ID [is an anti-pattern][index-as-key-antipattern]
  > because it can negatively impact performance and cause issues with
  > component state.
...
- Always define explicit defaultProps for all non-required props.
  ...
  > it can mean that your code can omit certain type checks.
...
- Use spread props sparingly.
  ...
  > [pass invalid HTML attributes to the DOM][dom-attributes-react-16].
  ...
  - Spreading objects with known, explicit props. This can be particularly
    useful when testing React components with Mocha's beforeEach construct.
  ...
  Notes for use:
  Filter out unnecessary props when possible. Also, use
  [prop-types-exact][prop-types-exact] to help prevent bugs.
...
[aria-roles]: https://www.w3.org/TR/wai-aria/#usage_intro
...
[index-as-key-antipattern]: https://medium.com/@robinpokorny/index-as-a-key-is-an-anti-pattern-e0349aece318
[dom-attributes-react-16]: https://reactjs.org/blog/2017/09/08/dom-attributes-in-react-16.html
[prop-types-exact]: https://www.npmjs.com/package/prop-types-exact
...
- If your component has multiline properties, close its tag on a new line.
  eslint: [`react/jsx-closing-bracket-location`][react-jsx-closing-bracket-location]
...
- Use arrow functions to close over local variables. It is handy when you need
  to pass additional data to an event handler. Although, make sure they
  [do not massively hurt performance][react-event-handlers], in particular when
  passed to custom components that might be PureComponents, because they will
  trigger a possibly needless rerender every time.
...
- Bind event handlers for the render method in the constructor. eslint:
  ...
  > single render. Do not use arrow functions in class fields, because it makes
  > them [challenging to test and debug, and can negatively impact
  > performance][arrow-functions-class-properties], and because conceptually,
  > class fields are for data, not logic.
...
- Do not use underscore prefix for internal methods of a React component.
  ...
  > native support for privacy in JavaScript, everything is public. Regardless
  > of your intentions, adding underscore prefixes to your properties does not
  > actually make them private, and any property (underscore-prefixed or not)
  > should be treated as being public. See issues
  > [#1024][github-issue-1024], and [#490][github-issue-490] for a more
  > in-depth discussion.
...
[react-event-handlers]: https://www.bignerdranch.com/blog/choosing-the-best-approach-for-react-event-handlers/
[react-jsx-no-bind]: https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/jsx-no-bind.md
[arrow-functions-class-properties]: https://medium.com/@charpeni/arrow-functions-in-class-properties-might-not-be-as-great-as-we-think-3b3551c440b1
[github-issue-1024]: https://github.com/airbnb/javascript/issues/1024
[github-issue-490]: https://github.com/airbnb/javascript/issues/490
...
- Ordering for `class extends React.Component`:
  ...
  1. *event handlers starting with 'handle'* like `handleSubmit()` or
     `handleChangeDescription()`
  1. *event handlers starting with 'on'* like `onClickSubmit()` or
     `onChangeDescription()`
  1. *getter methods for `render`* like `getSelectReason()` or
     `getFooterContent()`
  1. *optional render methods* like `renderNavigation()` or
...
- Ordering for `React.createClass`: eslint:
  ...
  1. `componentDidUpdate`
  1. `componentWillUnmount`
  1. *clickHandlers or eventHandlers* like `onClickSubmit()` or
     `onChangeDescription()`
  1. *getter methods for `render`* like `getSelectReason()` or
     `getFooterContent()`
  1. *optional render methods* like `renderNavigation()` or
...
[react-sort-comp]: https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/sort-comp.md
...
- Do not use `isMounted`. eslint:
  ...
  > Why? [`isMounted` is an anti-pattern][ismounted-antipattern], is not
...
[ismounted-antipattern]: https://facebook.github.io/react/blog/2015/12/16/ismounted-antipattern.html
...
- ![cn](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png)
  **Chinese (Simplified)**: [jhcccc/javascript][translation-cn]
- ![tw](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Taiwan.png)
  **Chinese (Traditional)**: [jigsawye/javascript][translation-tw]
- ![es](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Spain.png)
  **Espanol**: [agrcrobles/javascript][translation-es]
- ![jp](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Japan.png)
  **Japanese**: [mitsuruog/javascript-style-guide][translation-jp]
- ![kr](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/South-Korea.png)
  **Korean**: [apple77y/javascript][translation-kr]
- ![pl](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Poland.png)
  **Polish**: [pietraszekl/javascript][translation-pl]
- ![Br](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Brazil.png)
  **Portuguese**: [ronal2do/javascript][translation-br]
- ![ru](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Russia.png)
  **Russian**: [leonidlebedev/javascript-airbnb][translation-ru]
- ![th](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Thailand.png)
  **Thai**: [lvarayut/javascript-style-guide][translation-th]
- ![tr](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Turkey.png)
  **Turkish**: [alioguzhan/react-style-guide][translation-tr]
- ![ua](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Ukraine.png)
  **Ukrainian**: [ivanzusko/javascript][translation-ua]
- ![vn](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/Vietnam.png)
  **Vietnam**: [uetcodecamp/jsx-style-guide][translation-vn]

[translation-cn]: https://github.com/jhcccc/javascript/tree/master/react
[translation-tw]: https://github.com/jigsawye/javascript/tree/master/react
[translation-es]: https://github.com/agrcrobles/javascript/tree/master/react
[translation-jp]: https://github.com/mitsuruog/javascript-style-guide/tree/master/react
[translation-kr]: https://github.com/apple77y/javascript/tree/master/react
[translation-pl]: https://github.com/pietraszekl/javascript/tree/master/react
[translation-br]: https://github.com/ronal2do/airbnb-react-styleguide
[translation-ru]: https://github.com/leonidlebedev/javascript-airbnb/tree/master/react
[translation-th]: https://github.com/lvarayut/javascript-style-guide/tree/master/react
[translation-tr]: https://github.com/alioguzhan/react-style-guide
[translation-ua]: https://github.com/ivanzusko/javascript/tree/master/react
[translation-vn]: https://github.com/UETCodeCamp/jsx-style-guide
